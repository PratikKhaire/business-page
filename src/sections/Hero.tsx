    ...
    <div className="container lg:px-0">
      <div className="md:flex items-center justify-center gap-16">
        ...
        <div className="pt-12 md:mt-0 md:h-[648px] md:w-[648px] lg:h-[600px] relative">
          <Image src={cogImage} alt="cog image" className="md:absolute md:h-full md:w-auto md:max-w-none lg:-left-10 lg:-top-4"/>
          <Image src={cylinderImage} alt="cylinder img " width={220} height={220} className="hidden md:block -top-8 -left-32 md:absolute lg:-left-44"/>
          <Image src={noodleImage} alt="noodle image" width={220 }  className="hidden lg:block absolute top-[520px] left-[350px] rotate-[30deg]"/>
        </div>
      </div>
    </div>
  </section>;
